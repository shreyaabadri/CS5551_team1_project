...
//   }
  ...
  get_info(){
    ...
    let postParams = {
      user: {"email": "amar@amar.com", "password": "amar123"}
    }
    this.http.post("http://localhost:3000/users/sign_in", postParams, options)
      .subscribe(data => {
      console.log('amar -1 1 1 1 1');
...
export class ModalContentPage {
  ...
  constructor(
    ...
    this.peopleServiceProvider.loadingg()
        .then(data => {
          loading.dismiss();
